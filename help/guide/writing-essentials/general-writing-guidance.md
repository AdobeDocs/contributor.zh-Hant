...
| 了解這些小技巧就能提高清晰度 | <ul><li>避免&#x200B;*以便於* (這沒有增添任何意義)。 你只需要使用&#x200B;*以*&#x200B;即可。</li><li>避免&#x200B;*利用。* 這聽起來可能更具技術性，但事實並非如此。 *利用*&#x200B;表示&#x200B;*善加利用，尤其是那些不是為了這個目的但會提供*&#x200B;的專案。</li><li>避免使用分號：改用句號並開始一個新句子。 分號會增加不必要的複雜性。</li><li>冒號：使用冒號來引入清單。 在句子中請謹慎使用冒號。 句子中冒號後的第一個字詞使用大寫。</li><li>使用牛津逗號 (清單中的三個逗號)。</li><li>將句子長度保持在 39 字以下。</li><li>導覽：使用&#x200B;*前往*&#x200B;或&#x200B;*造訪*。</li><li>除非顯示路徑是重要資訊，否則避免使用原始網址 (URL) 文字 (使用簡明的連結文字)。</li></ul> |
